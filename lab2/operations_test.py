...
class Test_TestTextOperations(unittest.TestCase):
    ...
    def test_merge_characters_and_duplicate(self):
        self.assertEqual(operations.merge_characters_and_duplicate("Programowanie Skryptowe"), "PwPwPwPwPwPwPwPwPwPwPwPwPwPwPwPwPwPwPwPwPwPwPw")
        self.assertEqual(operations.merge_characters_and_duplicate("Pizza"), "PzPzPzPzPz")
        self.assertEqual(operations.merge_characters_and_duplicate("1234567890"), "19191919191919191919")
